"""
=================================================================================
TESTE COMPARATIVO COMPLETO - HNO2 (Himmelblau Nonlinear Optimization V2)
=================================================================================
...
from projeto_ia_experimental.problema.himmel import HimmelblauHNO2
...
if __name__ == "__main__":
    ...
    print("\n" + "="*80)
    print("TESTE COMPARATIVO COMPLETO - HNO2 (HIMMELBLAU NONLINEAR OPT. V2)")
    print("="*80)
    print(f"\nParâmetros gerais:")
    ...
    print("\n" + "="*80)
    print("TABELA COMPARATIVA (SIMILAR À TABELA 9 - HNO2)")
    print("="*80)
    ...
    # Salvar em CSV
    df_resultados.to_csv('resultados_hno2.csv', index=False)
    print("\n✓ Tabela salva em: resultados_hno2.csv")
    ...
    ax.set_title('Convergência Média - HNO2 (Himmelblau Nonlinear Opt. V2)',
    ...
    plt.tight_layout()
    plt.savefig('convergencia_hno2.png', dpi=300, bbox_inches='tight')
    print("✓ Gráfico de convergência salvo em: convergencia_hno2.png")
    ...
    ax1.set_title('Comparação por Algoritmo - HNO2', fontsize=13, fontweight='bold')
    ...
    ax2.set_title('Comparação por Crossover - HNO2', fontsize=13, fontweight='bold')
    ax2.grid(True, alpha=0.3, axis='y')
    
    plt.tight_layout()
    plt.savefig('boxplots_hno2.png', dpi=300, bbox_inches='tight')
    print("✓ Box plots salvos em: boxplots_hno2.png")
    ...
    print("="*80)
    print("  1. resultados_hno2.csv          - Tabela de resultados estatísticos")
    print("  2. convergencia_hno2.png        - Plot de convergência média")
    print("  3. boxplots_hno2.png            - Box plots comparativos")
    
    print("\n✅ Teste comparativo HNO2 finalizado com sucesso!")
    print("="*80 + "\n")
