"""
=================================================================================
TESTE COMPARATIVO COMPLETO - REPLICAÇÃO TABELA 13 DO ARTIGO
=================================================================================
...
2. Plots de convergência para cada configuração (similar à Figura 10)
=================================================================================
"""
...
if __name__ == "__main__":
    ...
    print("\n" + "="*80)
    print("TESTE COMPARATIVO COMPLETO - TABELA 13 + PLOT DE CONVERGÊNCIA")
    print("="*80)
    print(f"\nParâmetros gerais:")
    ...
    ax.set_ylabel('Fitness Médio (Volume cm³)', fontsize=12, fontweight='bold')
    ax.set_title('Convergência Média - Three-Bar Truss (TBT)',
    ...
    print("✓ Gráfico de convergência salvo em: convergencia_comparativa.png")
    ...
    ax1.set_ylabel('Fitness (Volume)', fontsize=12)
    ax1.set_title('Comparação por Algoritmo', fontsize=13, fontweight='bold')
    ...
    ax2.set_ylabel('Fitness (Volume)', fontsize=12)
    ax2.set_title('Comparação por Crossover', fontsize=13, fontweight='bold')
    ax2.grid(True, alpha=0.3, axis='y')
    
    plt.tight_layout()
    plt.savefig('boxplots_comparativos.png', dpi=300, bbox_inches='tight')
    print("✓ Box plots salvos em: boxplots_comparativos.png")
    ...
    print("="*80)
    print("  1. resultados_comparativos.csv      - Tabela de resultados estatísticos")
    print("  2. convergencia_comparativa.png     - Plot de convergência média de cada config")
    print("  3. boxplots_comparativos.png        - Box plots por algoritmo/crossover")
    
    print("\n✅ Teste comparativo completo finalizado com sucesso!")
    print("="*80 + "\n")
