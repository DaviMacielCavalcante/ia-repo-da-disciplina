"""
=================================================================================
TESTE COMPARATIVO COMPLETO - SRD (Speed Reducer Design)
=================================================================================
...
from projeto_ia_experimental.problema.srd import SpeedReducerProblem
...
if __name__ == "__main__":
    ...
    print("\n" + "="*80)
    print("TESTE COMPARATIVO COMPLETO - SRD (SPEED REDUCER DESIGN)")
    print("="*80)
    print(f"\nParâmetros gerais:")
    ...
    print("\n" + "="*80)
    print("TABELA COMPARATIVA (SIMILAR À TABELA 9 - SRD)")
    print("="*80)
    ...
    # Salvar em CSV
    df_resultados.to_csv('resultados_srd.csv', index=False)
    print("\n✓ Tabela salva em: resultados_srd.csv")
    ...
    ax.set_title('Convergência Média - SRD (Speed Reducer Design)',
    ...
    plt.tight_layout()
    plt.savefig('convergencia_srd.png', dpi=300, bbox_inches='tight')
    print("✓ Gráfico de convergência salvo em: convergencia_srd.png")
    ...
    ax1.set_title('Comparação por Algoritmo - SRD', fontsize=13, fontweight='bold')
    ...
    ax2.set_title('Comparação por Crossover - SRD', fontsize=13, fontweight='bold')
    ax2.grid(True, alpha=0.3, axis='y')
    
    plt.tight_layout()
    plt.savefig('boxplots_srd.png', dpi=300, bbox_inches='tight')
    print("✓ Box plots salvos em: boxplots_srd.png")
    ...
    print("="*80)
    print("  1. resultados_srd.csv           - Tabela de resultados estatísticos")
    print("  2. convergencia_srd.png         - Plot de convergência média")
    print("  3. boxplots_srd.png             - Box plots comparativos")
    
    print("\n✅ Teste comparativo SRD finalizado com sucesso!")
    print("="*80 + "\n")
