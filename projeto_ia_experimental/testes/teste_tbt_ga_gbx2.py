...
gbx2 = GBX2Crossover(num_rounds=10, max_iter=config['num_geracoes'])
...
for i in range(num_execucoes):
    ...
    ag = AlgoritmoGenetico(problem, config, crossover_operator=gbx2)
...
# -------------------------
plt.tight_layout()
plt.savefig('resultado_experimento_teste_tbt_ga_gbx2_completo.png', dpi=300, bbox_inches='tight')
print("\n✓ Gráficos salvos em 'resultado_experimento_teste_tbt_ga_gbx2_completo.png'")
plt.show()
...
with open('resultado_experimento_teste_tbt_ga_gbx2_completo.txt', 'w', encoding='utf-8') as f:
    f.write("=" * 80 + "\n")
...
print("✓ Resultados salvos em 'resultado_experimento_teste_tbt_ga_gbx2_completo.txt'")
