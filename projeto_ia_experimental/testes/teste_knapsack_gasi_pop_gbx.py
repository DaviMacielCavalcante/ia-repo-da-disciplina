"""
Teste do GASI-POP + GBX no Problema da Mochila
"""
...
print("=" * 60)
print("TESTE: GASI-POP + GBX NO PROBLEMA DA MOCHILA")
print("=" * 60)
print(f"Itens: {len(weights)}")
print(f"Capacidade: {capacity}")

print("\nExecutando GASI-POP com GBX...")
gbx = GBXCrossover(num_rounds=10)
gasi = GASIPOP(problem, config, crossover_operator=gbx)
