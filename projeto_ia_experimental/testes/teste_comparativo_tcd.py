"""
=================================================================================
TESTE COMPARATIVO COMPLETO - TCD (Tabular Column Design)
=================================================================================
...
from projeto_ia_experimental.problema import TabularColumnProblem
...
CONFIG_GERAL = {
    'num_execucoes': 60,           # 30 execuções independentes (como no artigo)
...
def executar_experimento(config_exp, config_geral, problema):
    ...
    print(f"  Mean={estatisticas['Mean']:.4f}, Best={estatisticas['Best']:.4f}, Viáveis={estatisticas['Num_Viaveis']}/30")
...
if __name__ == "__main__":
    ...
    print("\n" + "="*80)
    print("TESTE COMPARATIVO COMPLETO - TCD (TABULAR COLUMN DESIGN)")
    print("="*80)
    print(f"\nParâmetros gerais:")
    ...
    # Salvar em CSV
    df_resultados.to_csv('resultados_tcd.csv', index=False)
    print("\n✓ Tabela salva em: resultados_tcd.csv")
    ...
    ax.set_title('Convergência Média - TCD (Tabular Column Design)',
    ...
    plt.tight_layout()
    plt.savefig('convergencia_tcd.png', dpi=300, bbox_inches='tight')
    print("✓ Gráfico de convergência salvo em: convergencia_tcd.png")
    ...
    ax1.set_title('Comparação por Algoritmo - TCD', fontsize=13, fontweight='bold')
    ...
    ax2.set_title('Comparação por Crossover - TCD', fontsize=13, fontweight='bold')
    ax2.grid(True, alpha=0.3, axis='y')
    
    plt.tight_layout()
    plt.savefig('boxplots_tcd.png', dpi=300, bbox_inches='tight')
    print("✓ Box plots salvos em: boxplots_tcd.png")
    ...
    print("="*80)
    print("  1. resultados_tcd.csv           - Tabela de resultados estatísticos")
    print("  2. convergencia_tcd.png         - Plot de convergência média")
    print("  3. boxplots_tcd.png             - Box plots comparativos")
    
    print("\n✅ Teste comparativo TCD finalizado com sucesso!")
    print("="*80 + "\n")
