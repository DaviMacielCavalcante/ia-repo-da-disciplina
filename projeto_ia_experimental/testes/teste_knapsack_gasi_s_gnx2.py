"""
Teste do GASI-S + GBX2 no Problema da Mochila
"""
...
print("=" * 60)
print("TESTE: GASI-S + GBX2 NO PROBLEMA DA MOCHILA")
print("=" * 60)
print(f"Itens: {len(weights)}")
print(f"Capacidade: {capacity}")

print("\nExecutando GASI-S com GBX2...")
gbx2 = GBX2Crossover(num_rounds=10)
gasi = GASIS(problem, config, crossover_operator=gbx2)
