"""
=================================================================================
TESTE COMPARATIVO COMPLETO - WBD2 (Welded Beam Design Version 2)
=================================================================================
...
from projeto_ia_experimental.problema.welded import WeldedBeamWBD2
...
if __name__ == "__main__":
    ...
    print("\n" + "="*80)
    print("TESTE COMPARATIVO COMPLETO - WBD2 (WELDED BEAM DESIGN VERSION 2)")
    print("="*80)
    print(f"\nParâmetros gerais:")
    ...
    print(f"  - 7 restrições (6 de WBD1 + g7)")
    ...
    print("\n" + "="*80)
    print("TABELA COMPARATIVA (SIMILAR À TABELA 9 - WBD2)")
    print("="*80)
    ...
    # Salvar em CSV
    df_resultados.to_csv('resultados_wbd2.csv', index=False)
    print("\n✓ Tabela salva em: resultados_wbd2.csv")
    ...
    ax.set_title('Convergência Média - WBD2 (Welded Beam Design V2)',
    ...
    plt.tight_layout()
    plt.savefig('convergencia_wbd2.png', dpi=300, bbox_inches='tight')
    print("✓ Gráfico de convergência salvo em: convergencia_wbd2.png")
    ...
    ax1.set_title('Comparação por Algoritmo - WBD2', fontsize=13, fontweight='bold')
    ...
    ax2.set_title('Comparação por Crossover - WBD2', fontsize=13, fontweight='bold')
    ax2.grid(True, alpha=0.3, axis='y')
    
    plt.tight_layout()
    plt.savefig('boxplots_wbd2.png', dpi=300, bbox_inches='tight')
    print("✓ Box plots salvos em: boxplots_wbd2.png")
    ...
    print("="*80)
    print("  1. resultados_wbd2.csv          - Tabela de resultados estatísticos")
    print("  2. convergencia_wbd2.png        - Plot de convergência média")
    print("  3. boxplots_wbd2.png            - Box plots comparativos")
    
    print("\n✅ Teste comparativo WBD2 finalizado com sucesso!")
    print("="*80 + "\n")
