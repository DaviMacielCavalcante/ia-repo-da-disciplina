"""
=================================================================================
TESTE COMPARATIVO COMPLETO - HNO1 (Himmelblau Nonlinear Optimization V1)
=================================================================================
...
from projeto_ia_experimental.problema.himmel import HimmelblauHNO1
...
if __name__ == "__main__":
    ...
    print("\n" + "="*80)
    print("TESTE COMPARATIVO COMPLETO - HNO1 (HIMMELBLAU NONLINEAR OPT. V1)")
    print("="*80)
    print(f"\nParâmetros gerais:")
    ...
    print("\n" + "="*80)
    print("TABELA COMPARATIVA (SIMILAR À TABELA 9 - HNO1)")
    print("="*80)
    ...
    # Salvar em CSV
    df_resultados.to_csv('resultados_hno1.csv', index=False)
    print("\n✓ Tabela salva em: resultados_hno1.csv")
    ...
    ax.set_title('Convergência Média - HNO1 (Himmelblau Nonlinear Opt. V1)',
    ...
    plt.tight_layout()
    plt.savefig('convergencia_hno1.png', dpi=300, bbox_inches='tight')
    print("✓ Gráfico de convergência salvo em: convergencia_hno1.png")
    ...
    ax1.set_title('Comparação por Algoritmo - HNO1', fontsize=13, fontweight='bold')
    ...
    ax2.set_title('Comparação por Crossover - HNO1', fontsize=13, fontweight='bold')
    ax2.grid(True, alpha=0.3, axis='y')
    
    plt.tight_layout()
    plt.savefig('boxplots_hno1.png', dpi=300, bbox_inches='tight')
    print("✓ Box plots salvos em: boxplots_hno1.png")
    ...
    print("="*80)
    print("  1. resultados_hno1.csv          - Tabela de resultados estatísticos")
    print("  2. convergencia_hno1.png        - Plot de convergência média")
    print("  3. boxplots_hno1.png            - Box plots comparativos")
    
    print("\n✅ Teste comparativo HNO1 finalizado com sucesso!")
    print("="*80 + "\n")
