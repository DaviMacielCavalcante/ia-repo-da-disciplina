"""
=================================================================================
TESTE COMPARATIVO COMPLETO - WELDED BEAM DESIGN
=================================================================================
...
from projeto_ia_experimental.problema import WeldedBeamProblem
...
CONFIG_GERAL = {
    'num_execucoes': 30,           # 30 execuções independentes (como no artigo)
...
if __name__ == "__main__":
    ...
    print("\n" + "="*80)
    print("TESTE COMPARATIVO COMPLETO - WELDED BEAM DESIGN")
    print("="*80)
    print(f"\nParâmetros gerais:")
    ...
    # Salvar em CSV
    df_resultados.to_csv('resultados_welded.csv', index=False)
    print("\n✓ Tabela salva em: resultados_welded.csv")
    ...
    ax.set_title('Convergência Média - Welded Beam Design',
    ...
    plt.tight_layout()
    plt.savefig('convergencia_welded.png', dpi=300, bbox_inches='tight')
    print("✓ Gráfico de convergência salvo em: convergencia_welded.png")
    ...
    ax1.set_title('Comparação por Algoritmo - Welded Beam', fontsize=13, fontweight='bold')
    ...
    ax2.set_title('Comparação por Crossover - Welded Beam', fontsize=13, fontweight='bold')
    ax2.grid(True, alpha=0.3, axis='y')
    
    plt.tight_layout()
    plt.savefig('boxplots_welded.png', dpi=300, bbox_inches='tight')
    print("✓ Box plots salvos em: boxplots_welded.png")
    ...
    print("="*80)
    print("  1. resultados_welded.csv        - Tabela de resultados estatísticos")
    print("  2. convergencia_welded.png      - Plot de convergência média")
    print("  3. boxplots_welded.png          - Box plots comparativos")
    
    print("\n✅ Teste comparativo Welded Beam finalizado com sucesso!")
    print("="*80 + "\n")
