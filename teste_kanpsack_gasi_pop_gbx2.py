"""
Teste do GASI-POP + GBX2 no Problema da Mochila
"""
...
print("=" * 60)
print("TESTE: GASI-POP + GBX2 NO PROBLEMA DA MOCHILA")
print("=" * 60)
print(f"Itens: {len(weights)}")
print(f"Capacidade: {capacity}")

print("\nExecutando GASI-POP com GBX2...")
gbx2 = GBX2Crossover(num_rounds=10)
gasi = GASIPOP(problem, config, crossover_operator=gbx2)
