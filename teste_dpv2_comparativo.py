"""
=================================================================================
TESTE COMPARATIVO COMPLETO - DPV2 (Pressure Vessel Design Version 2)
=================================================================================
...
from projeto_ia_experimental.problema.pressure import PressureVesselDPV2
...
if __name__ == "__main__":
    ...
    print("\n" + "="*80)
    print("TESTE COMPARATIVO COMPLETO - DPV2 (PRESSURE VESSEL DESIGN VERSION 2)")
    print("="*80)
    print(f"\nParâmetros gerais:")
    ...
    print("\n" + "="*80)
    print("TABELA COMPARATIVA (SIMILAR À TABELA 9 - DPV2)")
    print("="*80)
    ...
    # Salvar em CSV
    df_resultados.to_csv('resultados_dpv2.csv', index=False)
    print("\n✓ Tabela salva em: resultados_dpv2.csv")
    ...
    ax.set_title('Convergência Média - DPV2 (Pressure Vessel Design V2)',
    ...
    plt.tight_layout()
    plt.savefig('convergencia_dpv2.png', dpi=300, bbox_inches='tight')
    print("✓ Gráfico de convergência salvo em: convergencia_dpv2.png")
    ...
    ax1.set_title('Comparação por Algoritmo - DPV2', fontsize=13, fontweight='bold')
    ...
    ax2.set_title('Comparação por Crossover - DPV2', fontsize=13, fontweight='bold')
    ax2.grid(True, alpha=0.3, axis='y')
    
    plt.tight_layout()
    plt.savefig('boxplots_dpv2.png', dpi=300, bbox_inches='tight')
    print("✓ Box plots salvos em: boxplots_dpv2.png")
    ...
    print("="*80)
    print("  1. resultados_dpv2.csv          - Tabela de resultados estatísticos")
    print("  2. convergencia_dpv2.png        - Plot de convergência média")
    print("  3. boxplots_dpv2.png            - Box plots comparativos")
    
    print("\n✅ Teste comparativo DPV2 finalizado com sucesso!")
    print("="*80 + "\n")
