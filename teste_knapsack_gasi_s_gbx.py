"""
Teste do GASI-S + GBX no Problema da Mochila
"""
...
print("=" * 60)
print("TESTE: GASI-S + GBX NO PROBLEMA DA MOCHILA")
print("=" * 60)
print(f"Itens: {len(weights)}")
print(f"Capacidade: {capacity}")

print("\nExecutando GASI-S com GBX...")
gbx = GBXCrossover(num_rounds=10)
gasi = GASIS(problem, config, crossover_operator=gbx)
