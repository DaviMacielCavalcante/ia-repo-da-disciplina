...
# -------------------------
plt.tight_layout()
plt.savefig('resultado_experimento_teste_tbt_gasis_completo.png', dpi=300, bbox_inches='tight')
print("\n✓ Gráficos salvos em 'resultado_experimento_teste_tbt_gasis_completo.png'")
plt.show()
...
with open('resultado_experimento_teste_tbt_gasis_completo.txt', 'w', encoding='utf-8') as f:
    f.write("=" * 80 + "\n")
...
print("✓ Resultados salvos em 'resultado_experimento_teste_tbt_gasis_completo.txt'")
