"""
=================================================================================
TESTE COMPARATIVO COMPLETO - DPV1 (Pressure Vessel Design Version 1)
=================================================================================
...
from projeto_ia_experimental.problema.pressure import PressureVesselDPV1
...
if __name__ == "__main__":
    ...
    print("\n" + "="*80)
    print("TESTE COMPARATIVO COMPLETO - DPV1 (PRESSURE VESSEL DESIGN VERSION 1)")
    print("="*80)
    print(f"\nParâmetros gerais:")
    ...
    print(f"  - Tamanho torneio: {CONFIG_GERAL['tamanho_torneio']}")
    print(f"  - Número de elites: {CONFIG_GERAL['num_elites']}")
    ...
    print("\n" + "="*80)
    print("TABELA COMPARATIVA (SIMILAR À TABELA 9 - DPV1)")
    print("="*80)
    ...
    # Salvar em CSV
    df_resultados.to_csv('resultados_dpv1.csv', index=False)
    print("\n✓ Tabela salva em: resultados_dpv1.csv")
    ...
    ax.set_title('Convergência Média - DPV1 (Pressure Vessel Design V1)',
    ...
    plt.tight_layout()
    plt.savefig('convergencia_dpv1.png', dpi=300, bbox_inches='tight')
    print("✓ Gráfico de convergência salvo em: convergencia_dpv1.png")
    ...
    ax1.set_title('Comparação por Algoritmo - DPV1', fontsize=13, fontweight='bold')
    ...
    ax2.set_title('Comparação por Crossover - DPV1', fontsize=13, fontweight='bold')
    ax2.grid(True, alpha=0.3, axis='y')
    
    plt.tight_layout()
    plt.savefig('boxplots_dpv1.png', dpi=300, bbox_inches='tight')
    print("✓ Box plots salvos em: boxplots_dpv1.png")
    ...
    print("="*80)
    print("  1. resultados_dpv1.csv          - Tabela de resultados estatísticos")
    print("  2. convergencia_dpv1.png        - Plot de convergência média")
    print("  3. boxplots_dpv1.png            - Box plots comparativos")
    
    print("\n✅ Teste comparativo DPV1 finalizado com sucesso!")
    print("="*80 + "\n")
