"""
=================================================================================
TESTE COMPARATIVO COMPLETO - MWTCS (Spring Problem)
=================================================================================
...
from projeto_ia_experimental.problema import SpringProblem
...
if __name__ == "__main__":
    ...
    print("\n" + "="*80)
    print("TESTE COMPARATIVO COMPLETO - MWTCS (SPRING PROBLEM)")
    print("="*80)
    print(f"\nParâmetros gerais:")
    ...
    # Salvar em CSV
    df_resultados.to_csv('resultados_mwtcs.csv', index=False)
    print("\n✓ Tabela salva em: resultados_mwtcs.csv")
    ...
    ax.set_title('Convergência Média - MWTCS (Spring Problem)',
    ...
    plt.tight_layout()
    plt.savefig('convergencia_mwtcs.png', dpi=300, bbox_inches='tight')
    print("✓ Gráfico de convergência salvo em: convergencia_mwtcs.png")
    ...
    ax1.set_title('Comparação por Algoritmo - MWTCS', fontsize=13, fontweight='bold')
    ...
    ax2.set_title('Comparação por Crossover - MWTCS', fontsize=13, fontweight='bold')
    ax2.grid(True, alpha=0.3, axis='y')
    
    plt.tight_layout()
    plt.savefig('boxplots_mwtcs.png', dpi=300, bbox_inches='tight')
    print("✓ Box plots salvos em: boxplots_mwtcs.png")
    ...
    print("="*80)
    print("  1. resultados_mwtcs.csv         - Tabela de resultados estatísticos")
    print("  2. convergencia_mwtcs.png       - Plot de convergência média")
    print("  3. boxplots_mwtcs.png           - Box plots comparativos")
    
    print("\n✅ Teste comparativo MWTCS finalizado com sucesso!")
    print("="*80 + "\n")
